...
int main(int argc, char** argv)
{
    ...
    std::normal_distribution<> gaussianDis2(0.0, 0.848);
    ...
    /*xyzFile << particles[1].size() << std::endl << std::endl;
    std::cout << particles[1].size() << std::endl;

    for(int p = particles[1].size()-1; p > -1; p--)
    {
